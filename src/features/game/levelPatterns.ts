...
export const LEVEL_PATTERNS: LevelPattern[] = [
  // RESPITE PATTERNS - Low density, recovery moments
  {
    ...
    spawns: [
      ...
      { type: ObjectType.BEER, lane: 0, zOffset: 10 },
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 14 },
      { type: ObjectType.BEER, lane: -1, zOffset: 18 },
      { type: ObjectType.OBSTACLE, lane: 0, zOffset: 22 },
      { type: ObjectType.BEER, lane: 1, zOffset: 26 },
    ],
...

  {
    ...
    duration: 6,
    spawns: [
      { type: ObjectType.BEER, lane: -2, zOffset: 6 },
      { type: ObjectType.BEER, lane: -1, zOffset: 10 },
      { type: ObjectType.BEER, lane: 0, zOffset: 14 },
      { type: ObjectType.BEER, lane: 1, zOffset: 18 },
      { type: ObjectType.BEER, lane: 2, zOffset: 22 },
      { type: ObjectType.OBSTACLE, lane: 0, zOffset: 26 },
    ],
  ...
  // TENSION PATTERNS - Moderate challenge
  {
    ...
    duration: 10,
    spawns: [
      { type: ObjectType.OBSTACLE, lane: -2, zOffset: 6 },
      { type: ObjectType.ALIEN, lane: 2, zOffset: 10 },
      { type: ObjectType.OBSTACLE, lane: 0, zOffset: 14 },
      { type: ObjectType.BEER, lane: 1, zOffset: 16 },
      { type: ObjectType.ALIEN, lane: -1, zOffset: 20 },
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 24 },
      { type: ObjectType.BEER, lane: -1, zOffset: 28 },
    ],
...

  {
    ...
    spawns: [
      { type: ObjectType.OBSTACLE, lane: -2, zOffset: 6 },
      { type: ObjectType.OBSTACLE, lane: 2, zOffset: 10 },
      { type: ObjectType.OBSTACLE, lane: -1, zOffset: 14 },
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 18 },
      { type: ObjectType.OBSTACLE, lane: 0, zOffset: 22 },
      { type: ObjectType.BEER, lane: 1, zOffset: 24 },
      { type: ObjectType.OBSTACLE, lane: -2, zOffset: 28 },
      { type: ObjectType.BEER, lane: 0, zOffset: 32 },
    ],
  ...
  // PEAK PATTERNS - High intensity
  {
    ...
    spawns: [
      ...
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 6 },
      { type: ObjectType.OBSTACLE, lane: 2, zOffset: 6 },
      { type: ObjectType.BEER, lane: 0, zOffset: 12 },
      { type: ObjectType.ALIEN, lane: -1, zOffset: 14 },
      { type: ObjectType.ALIEN, lane: 1, zOffset: 14 },
      { type: ObjectType.OBSTACLE, lane: -1, zOffset: 18 },
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 18 },
    ],
...

  {
    ...
    spawns: [
      ...
      { type: ObjectType.MISSILE, lane: 0, zOffset: 20 },
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 24 },
      { type: ObjectType.BEER, lane: 0, zOffset: 28 },
    ],
  ...
  // VARIATION PATTERNS - Special set pieces
  {
    ...
    duration: 15,
    spawns: [
      { type: ObjectType.LETTER, lane: -2, zOffset: 8, value: 'C', targetIndex: 0 },
      { type: ObjectType.OBSTACLE, lane: 0, zOffset: 10 },
      { type: ObjectType.BEER, lane: 1, zOffset: 12 },
      { type: ObjectType.LETTER, lane: 2, zOffset: 16, value: 'A', targetIndex: 1 },
      { type: ObjectType.ALIEN, lane: -1, zOffset: 18 },
      { type: ObjectType.LETTER, lane: 0, zOffset: 22, value: 'L', targetIndex: 2 },
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 24 },
      { type: ObjectType.BEER, lane: -1, zOffset: 26 },
      { type: ObjectType.LETTER, lane: -1, zOffset: 30, value: 'A', targetIndex: 3 },
      { type: ObjectType.BEER, lane: 1, zOffset: 34 },
    ],
...

  {
    ...
    spawns: [
      { type: ObjectType.OBSTACLE, lane: 0, zOffset: 6 },
      { type: ObjectType.MISSILE, lane: -2, zOffset: 10 },
      { type: ObjectType.MISSILE, lane: -1, zOffset: 12 },
      { type: ObjectType.MISSILE, lane: 0, zOffset: 14 },
      { type: ObjectType.MISSILE, lane: 1, zOffset: 16 },
      { type: ObjectType.MISSILE, lane: 2, zOffset: 18 },
      { type: ObjectType.BEER, lane: 0, zOffset: 22 },
      { type: ObjectType.OBSTACLE, lane: -1, zOffset: 26 },
      { type: ObjectType.OBSTACLE, lane: 1, zOffset: 26 },
    ],
